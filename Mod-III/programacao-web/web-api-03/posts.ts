...
export const posts: Post[] = [
    { id: 1, title: 'Post 1', text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin tristique vestibulum ipsum. Sed rutrum consectetur condimentum.', date: '2022-01-01', likes: 5 },
    ...
    { id: 8, title: 'Post 8', text: 'Morbi fringilla enim vitae odio fermentum, ac dignissim nisi rutrum. Mauris euismod felis a nunc rutrum, id luctus lacus iaculis.', date: '2023-02-10', likes: 4 },
    { id: 9, title: 'Post 9', text: 'Etiam bibendum velit ligula, id maximus purus molestie nec. Sed auctor tortor vitae nisl dictum rhoncus.', date: '2023-04-01', likes: 6 },
    { id: 10, title: 'Post 10', text: 'Suspendisse vel fringilla lectus. Sed et leo non lacus feugiat venenatis eu id lacus.', date: '2023-06-15', likes: 9 },
    { id: 11, title: 'Post 11', text: 'Fusce vitae leo sed ex elementum tempor. Donec id purus semper, facilisis nunc non, cursus dui.', date: '2023-09-01', likes: 12 },
